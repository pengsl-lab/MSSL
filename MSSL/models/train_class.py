...
parser.add_argument('--seed', type=int, default=72, help='the random seed.')
...
parser.add_argument('--hidden', type=int, default=8, help='the number of hidden units.')
parser.add_argument('--nb_heads', type=int, default=8, help='the number of head attentions.')
parser.add_argument('--dropout', type=float, default=0.6, help='the dropout rate (1 - keep probability).')
...
parser.add_argument('--sub', type=int, default=0, help='the parameter is set as 1 in only PairDistance task')
