...
parser.add_argument('--train_file', type=str, default='./', help='the path of SSL training dataset.')
parser.add_argument('--test_file', type=str, default='./', help='the path of SSL testing dataset.')
